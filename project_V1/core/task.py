...
def sendRequest(usr,friend_handle,friend_email,url):
    ...
    if len(data)>0:
        ...
        send_mail("test mail","Hi mate, \n Your friend %s wants  to add you on BuddyUp .BuddyUp is a webapp which generates and shows trend based on the recent twitter activity.Please read the below privacy policy and take the action. \n \n Privacy Notice: This notice is to inform you that as a part of a research project [name of the project] undertaken for the completion of masters’ degree [course name] at [complete college name]. The research group shall be analyzing your twitter handle which comprises of [type of data] to understand human behavior. This information is anonymously used for the research project and does not directly or specifically identify you. To details on the processing of personal data, we wish to inform you that your personal data shall be [Process]. Please be informed that the information obtained under this research project will be erased without the possibility of reverse engineer, within [duration] from the submission of the research project. The motive of this research [elaborate on the outcome of the research]. Please note that the data obtained from this research project is purely for academic and non-commercial purpose. As we respect your right to privacy and in compliance with GDPR and ePrivacy Directives, we wish to procure a freely given, informed, unambiguous and explicit consent for processing the personal data available in your twitter handle. By click on the link, you can provide your consent and register with us. However, you do have an option to opt out of this research project by ignoring this mail. If you need any further details on the research project, you may feel free to contact us on mail@ucd.ie. We would be happy to walk you through the research outcomes. 127.0.0.1:8000/oauth/login/twitter/","a.team.ucd.5@gmail.com"%friend_name,[friend_email])
        friend_tweet.save()
